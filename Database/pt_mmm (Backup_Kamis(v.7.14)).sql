...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2022 at 05:42 AM
...
(1, 'ongkos sample', 50000, 0, 'AnggaKP', '2022-07-29', 'Superadmin', '2022-09-07'),
(2, 'fee', 20000, 0, 'AnggaKP', '2022-07-29', 'Superadmin', '2022-09-07'),
...
--
ALTER TABLE `tbl_2ddesainkepala`
  MODIFY `id_subdetailkepala` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
