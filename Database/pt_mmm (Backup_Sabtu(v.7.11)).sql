...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2022 at 10:23 AM
...
(1, '0002/Angga-PO/0822', '2022-08-31', '7', '', '<p>contoh ini mah</p>', 'New Design', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'Superadmin', '2022-08-31', '', '0000-00-00');
...
(1, 36, '0001/Angga-PO/0822', 0, 'Superadmin', '2022-08-27', '', '0000-00-00');
...
(37, NULL, NULL, NULL, 'User', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(38, 37, NULL, NULL, 'User Management', 2, 'listuser', 'tambahdatauser', 'editdatauser', NULL, NULL, 'fa-solid fa-user-gear', 1, '', 0),
(40, NULL, NULL, NULL, 'Pengaturan', 1, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 0),
(41, 40, NULL, NULL, 'Pengaturan', 2, 'pengaturan', 'tambahreference', NULL, NULL, NULL, 'fa-solid fa-gear', 1, NULL, 0),
...
--
ALTER TABLE `tbl_2ddesainkepala`
  MODIFY `id_subdetailkepala` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tbl_2ddesainsubdetail`
--
ALTER TABLE `tbl_2ddesainsubdetail`
  MODIFY `id_subdetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `tbl_detail_reference`
  MODIFY `id_reference` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
