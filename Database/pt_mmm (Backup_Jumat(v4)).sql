...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Jul 2022 pada 12.54
...
--
-- Struktur dari tabel `tbl_cashbankdetail`
--
...
--
-- Dumping data untuk tabel `tbl_cashbankdetail`
--
...
(10, '2', '2', '100,01', '3500', 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', 'AnggaKP', '2022-07-15'),
(11, '2', '2', '100,01', '2000', 'contoh saja', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00'),
(12, '2', '2', '100,01', '3000', 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00'),
(13, '2', '2', '100,01', '3000', 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00'),
(14, '2', '2', '100,01', '3000', 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00'),
(15, '2', '2', '100,01', '3000', 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00'),
(16, '2', '2', '100,01', '2000', 'contoh saja', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00'),
(17, '2', '2', '100,01', '3000', 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_cashbankheader`
--
...
--
-- Struktur dari tabel `tbl_cashbanklawan`
--
...
--
-- Dumping data untuk tabel `tbl_cashbanklawan`
--
...
(3, '2', '2', '100,01', 3500, 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', 'AnggaKP', '2022-07-15'),
(4, '2', '2', '100,01', 3000, 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00'),
(5, '2', '2', '100,02', 3000, 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00'),
(6, '2', '2', '100,01', 3000, 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00'),
(7, '2', '2', '100,01', 3222, 'beli minuman floridina', 1, 'AnggaKP', '2022-07-15', '', '0000-00-00');
...
--
-- Struktur dari tabel `tbl_groupakun`
--
...
--
-- Dumping data untuk tabel `tbl_groupakun`
--
...
--
-- Struktur dari tabel `tbl_warnaproduk`
--
...
--
-- Dumping data untuk tabel `tbl_warnaproduk`
--
...
--
-- Indeks untuk tabel `tbl_groupakun`
--
...
--
-- Indeks untuk tabel `tbl_warnaproduk`
--
...
--
-- AUTO_INCREMENT untuk tabel `tbl_cashbankdetail`
--
ALTER TABLE `tbl_cashbankdetail`
  MODIFY `id_cashbankdetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT untuk tabel `tbl_cashbanklawan`
--
ALTER TABLE `tbl_cashbanklawan`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_groupakun`
--
ALTER TABLE `tbl_groupakun`
...
--
ALTER TABLE `tbl_kurs`
  MODIFY `id_kurs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_warnaproduk`
--
ALTER TABLE `tbl_warnaproduk`
