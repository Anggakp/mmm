...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2022 at 08:48 AM
...
(1, '00001', '2022-08-18', '8', '3', '                                                                                                                                                                <ul data-testid=\"lblPDPInfoProduk\" class=\"css-1ijyj3z eytdjj02\" style=\"box-sizing: inherit; display: flex; flex-flow: column wrap; height: 96px; margin-bottom: -4px; padding: 0px; color: rgba(0, 0, 0, 0.54); font-family: \" open=\"\" sauce=\"\" one\",=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\"><li class=\"css-1dmo88g\" style=\"box-sizing: inherit; max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin: 0px 12px 4px 0px; padding: 0px; list-style-type: none; color: var(--N700,rgba(49,53,59,0.96)); font-size: 1rem; line-height: 20px;\"><span style=\"box-sizing: inherit; color: var(--N700,rgba(49,53,59,0.68));\">Kondisi: </span><span class=\"main\" style=\"box-sizing: inherit; color: var(--N700,rgba(49,53,59,0.96));\">Lama</span></li><li class=\"css-1dmo88g\" style=\"box-sizing: inherit; max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin: 0px 12px 4px 0px; padding: 0px; list-style-type: none; color: var(--N700,rgba(49,53,59,0.96)); font-size: 1rem; line-height: 20px;\"><span style=\"box-sizing: inherit; color: var(--N700,rgba(49,53,59,0.68));\">Berat Satuan: </span><span class=\"main\" style=\"box-sizing: inherit; color: var(--N700,rgba(49,53,59,0.96));\">408 g</span></li><li class=\"css-1dmo88g\" style=\"box-sizing: inherit; max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin: 0px 12px 4px 0px; padding: 0px; list-style-type: none; color: var(--N700,rgba(49,53,59,0.96)); font-size: 1rem; line-height: 20px;\"><span style=\"box-sizing: inherit; color: var(--N700,rgba(49,53,59,0.68));\">Kategori: </span><a href=\"https://www.tokopedia.com/p/elektronik/audio/headphone\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"box-sizing: inherit; color: var(--G500,#03AC0E);\"><span style=\"box-sizing: inherit; font-weight: bolder;\">Headphone</span></a></li><li class=\"css-1dmo88g\" style=\"box-sizing: inherit; max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin: 0px 12px 4px 0px; padding: 0px; list-style-type: none; color: var(--N700,rgba(49,53,59,0.96)); font-size: 1rem; line-height: 20px;\"><span style=\"box-sizing: inherit; color: var(--N700,rgba(49,53,59,0.68));\">Etalase: </span><a href=\"https://www.tokopedia.com/miniso-official/etalase/headphone\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"box-sizing: inherit; color: var(--G500,#03AC0E);\"><span style=\"box-sizing: inherit; font-weight: bolder;\">Headphone</span></a></li></ul><div class=\"css-1k1relq\" style=\"box-sizing: inherit; margin-top: 12px; font-size: 14px; line-height: 20px; color: var(--N700,rgba(49,53,59,0.96)); font-family: \" open=\"\" sauce=\"\" one\",=\"\" sans-serif;\"=\"\"><span class=\"css-11oczh8 eytdjj00\" style=\"box-sizing: inherit; display: contents; overflow: hidden; max-height: 160px;\"><span class=\"css-168ydy0 eytdjj01\" style=\"box-sizing: inherit; display: -webkit-box; -webkit-line-clamp: unset; -webkit-box-orient: vertical; text-overflow: ellipsis; overflow: hidden; word-break: break-word;\"><div data-testid=\"lblPDPDescriptionProduk\" style=\"box-sizing: inherit;\">MINISO Model Headphone Lipat: JB-950 Earphone Kualitas Suara Jernih.<br style=\"box-sizing: inherit;\"><br style=\"box-sizing: inherit;\">Bahan produk: ABS，PC<br style=\"box-sizing: inherit;\"><br style=\"box-sizing: inherit;\">Ukuran: 17x18x8cm<br style=\"box-sizing: inherit;\"><br style=\"box-sizing: inherit;\">Fitur: Dengan model minimalis dan bergaya & fungsi stabil, dapat diregangkan dan dilipat. Headset Berkabel</div></span></span></div>                                                                                                                                                        ', 'Client Order', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'AnggaKP', '2022-08-16', 'AnggaKP', '2022-08-18'),
...
(11, '6', 1100000, '2022-08-11 16:53:02', 0, 'AnggaKP', '2022-08-11', 'AnggaKP', '2022-08-12'),
...
(1, '<?php echo $this->lang->line(\'dashboard\'); ?>'),
(2, 'Master Produk');
...
(1, 1, '<?php echo $this->lang->line(\'dashboard\'); ?>', 'pimpinan', 'fas fa-fw fa-tachometer-alt', 1),
(2, 2, 'Produk', 'listproduk', '', 1);
...
--
ALTER TABLE `tbl_2ddesainsubdetail`
  MODIFY `id_subdetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `tbl_masterid`
  MODIFY `id_masterid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
