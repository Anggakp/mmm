...
(2, 'Admin', 'admin', 'default.png', '$2y$10$zgQDm4gaA4JQFtwWDv3e5eN7CXV4uhSaP1b.Oj0fkwfpZz4ENzKfu', 2, 1, '2021-01-01');
...
INSERT INTO `user_sub_menu` (`id`, `menu_id`, `title`, `url`, `url_1`, `url_2`, `url_3`, `url_4`, `icon`, `jenis`, `target`, `is_active`) VALUES
(1, 1, 'Dashboard', 'pimpinan', '', '', '', '', 'fas fa-fw fa-tachometer-alt', 1, '', 1),
...
(13, 5, 'Bagian', 'listbagian', 'tambahdatabagian', 'editdatakaryawan', '', '', 'fas fa-fw fa-book', 1, '', 1),
...
INSERT INTO `user_sub_sub_menu` (`id`, `sub_menu_id`, `title`, `url`, `url_1`, `url_2`, `target`, `is_active`) VALUES
