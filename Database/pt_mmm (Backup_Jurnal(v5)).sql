...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Jul 2022 pada 06.28
...
(1, '1', '00001', '100,01', '3000', 'beli minuman floridina', 1, 'AnggaKP', '2022-07-16', '', '0000-00-00');
...
INSERT INTO `tbl_cashbankheader` (`id_cashbankheader`, `id_matauang`, `inout`, `nomor`, `tanggal`, `typetransaksi`, `rate`, `subakun`, `total`, `memo`, `deleted`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
('1', '3', 'I', '00001', '0000-00-00', 'Reguler', '1.00', 'contoh', '6000', 'contoh', 1, 'AnggaKP', '2022-07-16', 'AnggaKP', '2022-07-16');
...
--
ALTER TABLE `tbl_cashbankdetail`
  MODIFY `id_cashbankdetail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `tbl_cashbanklawan`
--
ALTER TABLE `tbl_cashbanklawan`
  MODIFY `id_cashbanklawan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
