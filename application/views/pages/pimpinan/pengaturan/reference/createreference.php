                                ...
                                <table style="border-collapse: 1;color: #858796;border-bottom: 2px solid #e3e6f0;"  id="dataTable" width="100%" height="1px" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="20%">M/MM</td>
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart1_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan1" placeholder="M/MM"  id="referencepart_bulan1"   class="form-control">

                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun1" id="referencepart_tahun1" placeholder="YYYY/YY"  class="form-control">
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart2_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan2" placeholder="M/MM"  id="referencepart_bulan2"   class="form-control">
                      <input style="padding-bottom: 10px; display: none" type="text" name="referencepart_bulanview2"   id="referencepart_bulanview2"   class="form-control">

                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun2" id="referencepart_tahun2" placeholder="YYYY/YY"  class="form-control">
                      <input style="padding-bottom: 10px;display: none " type="text" name="referencepart_tahunview2" id="referencepart_tahunview2"  class="form-control">
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart3_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan3" placeholder="M/MM"  id="referencepart_bulan3"   class="form-control">
                      <input style="padding-bottom: 10px; display: none" type="text" name="referencepart_bulanview3"   id="referencepart_bulanview3"   class="form-control">

                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun3" id="referencepart_tahun3" placeholder="YYYY/YY"  class="form-control">
                      <input style="padding-bottom: 10px;display: none " type="text" name="referencepart_tahunview3" id="referencepart_tahunview3"  class="form-control">
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart4_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan4" placeholder="M/MM"  id="referencepart_bulan4"   class="form-control">
                      <input style="padding-bottom: 10px; display: none" type="text" name="referencepart_bulanview4"   id="referencepart_bulanview4"   class="form-control">

                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun4" id="referencepart_tahun4" placeholder="YYYY/YY"  class="form-control">
                      <input style="padding-bottom: 10px;display: none " type="text" name="referencepart_tahunview4" id="referencepart_tahunview4"  class="form-control">
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart5_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan5" placeholder="M/MM"  id="referencepart_bulan5"   class="form-control">
                      <input style="padding-bottom: 10px; display: none" type="text" name="referencepart_bulanview5"   id="referencepart_bulanview5"   class="form-control">

                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun5" id="referencepart_tahun5" placeholder="YYYY/YY"  class="form-control">
                      <input style="padding-bottom: 10px;display: none " type="text" name="referencepart_tahunview5" id="referencepart_tahunview5"  class="form-control">
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart6_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan6" placeholder="M/MM"  id="referencepart_bulan6"   class="form-control">
                      ...
                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun6" id="referencepart_tahun6" placeholder="YYYY/YY"  class="form-control">
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart7_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan7" placeholder="M/MM"  id="referencepart_bulan7"   class="form-control">
                      <input style="padding-bottom: 10px; display: none" type="text" name="referencepart_bulanview7"   id="referencepart_bulanview7"   class="form-control">

                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun7" id="referencepart_tahun7" placeholder="YYYY/YY"  class="form-control">
                      <input style="padding-bottom: 10px;display: none " type="text" name="referencepart_tahunview7" id="referencepart_tahunview7"  class="form-control">
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart8_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan8" placeholder="M/MM"  id="referencepart_bulan8"   class="form-control">
                      <input style="padding-bottom: 10px; display: none" type="text" name="referencepart_bulanview8"   id="referencepart_bulanview8"   class="form-control">

                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun8" id="referencepart_tahun8" placeholder="YYYY/YY"  class="form-control">
                      <input style="padding-bottom: 10px;display: none " type="text" name="referencepart_tahunview8" id="referencepart_tahunview8"  class="form-control">
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart9_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan9" placeholder="M/MM"  id="referencepart_bulan9"   class="form-control">
                      <input style="padding-bottom: 10px; display: none" type="text" name="referencepart_bulanview9"   id="referencepart_bulanview9"   class="form-control">

                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun9" id="referencepart_tahun9" placeholder="YYYY/YY"  class="form-control">
                      <input style="padding-bottom: 10px;display: none " type="text" name="referencepart_tahunview9" id="referencepart_tahunview9"  class="form-control">
                 ...
                 <div class="col-md-3">
                  <div class="form-group">
                    <div id="referencepart10_view">
                      ...
                      <!-- Reference Bulan -->
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_bulan10" placeholder="M/MM"  id="referencepart_bulan10"   class="form-control">
                      <input style="padding-bottom: 10px; display: none" type="text" name="referencepart_bulanview10"   id="referencepart_bulanview10"   class="form-control">

                      <!-- Reference Tahun --> 
                      <input style="padding-bottom: 10px;display: none" type="text" name="referencepart_tahun10" id="referencepart_tahun10" placeholder="YYYY/YY"  class="form-control">
                      <input style="padding-bottom: 10px;display: none " type="text" name="referencepart_tahunview10" id="referencepart_tahunview10"  class="form-control">
