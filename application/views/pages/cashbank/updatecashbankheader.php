<div class="content">
  <div class="container-fluid">
     ...
     <form action="<?php echo base_url() . 'cashbank/updatecashbankheader'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
    <div class="row">
        <div class="col-md-12">
                <h3 class="card-title" style=""><?php echo $this->lang->line('cbt'); ?></h3>
      ...
      <br>        
       <div class="row">
          ...
          <div class="card-body">
            ...
            <button type="submit" class="btn btn-info"><?php echo $this->lang->line('change'); ?></button> <a href="<?= base_url('listcashbank'); ?>" class="btn btn-danger"><?php echo $this->lang->line('cancel'); ?></a>
            </div>
