<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
           <h3   style=""><?php echo $this->lang->line('cbt'); ?></h3>
                ...
                <table class="table table-hover"  width="100%" cellspacing="0">
                                    ...
                                    <tbody id="updatedetail">
                                        ...
                                        <tr id="user<?= $data->id_cashbankdetail ?>">
                                         <form  action="<?php echo base_url() . 'cashbank/updatedetailcashbank'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
                                        ...
                                        <form   action="<?php echo base_url() . 'cashbank/addcashdetail'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">                                       
                  ...
                  <table class="table table-hover"   width="100%" cellspacing="0">
                                    ...
                                    <tbody id="updatedetaillawan">
                                       <?php
                                        ...
                                        <tr>
                                         <form action="<?php echo base_url() . 'cashbank/updatedetailcashbanklawan'; ?> "  method="post">                                       
                                          ...
                                          <td><input style="padding-bottom: 10px;width: 250px;text-align: right;"  value="<?php echo number_format($data->nilai,2,',','.') ?>" type="text" id="nilai4" name="nilai" class="form-control js-nilai" required >
                                          </td>
                                          ...
                                          <tr id="addform1" style="display: none">
                                           <form id="myForm" action="<?php echo base_url() . 'cashbank/addcashlawan'; ?> "  method="post">        
                                          <td>
                                            <div class="input-group">
