<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
         <h4 style="margin-bottom: 5px;padding-bottom: 5px" class="card-category"><?php echo $this->lang->line('add'); ?> Data BSIS</h4>
               ...
               <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;text-align: right" type="number" step="any" name="akun" class="form-control" value="<?= set_value('akun') ?>">
