<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
            <h4 style="margin-bottom: 5px;padding-bottom: 5px" class="card-category"><?php echo $this->lang->line('change'); ?> Data COA</h4>
        <div class="card"> 
          <div class="card-body"> 
            <?php foreach ($coa as $data) {
              ?>
            <form action="<?php echo base_url() . 'coa/updatecoa'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="namaakun" class="form-control" required value="<?=$data->namaakun?>">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('account'); ?></label>
                    <input style="padding-bottom: 10px;" type="text" name="akun" class="form-control" readonly value="<?=$data->akun?>">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select id="headerdetail" name="headerdetail" required class="form-control" >
                      <option value="<?=$data->headerdetail?>">Data Asal : <?=$data->headerdetail?></option>
                  ...
                  <div id="groupakun" class="form-group">
                    ...
                    <select name="idgroupakun" class="form-control" >
                       <option value="<?=$data->id_groupakun?>"><?php echo $this->lang->line('accountgroup'); ?> <?php echo $this->lang->line('early'); ?> : <?=$data->groupakun?></option>
