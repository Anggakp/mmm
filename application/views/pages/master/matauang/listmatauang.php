<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data <?php echo $this->lang->line('currency'); ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Home</li>
              <li class="breadcrumb-item active"><a class="text-info"  href="<?php echo base_url()?>listmatauang"><?php echo $this->lang->line('currency'); ?></a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <!-- /.card-header -->
               <div class="card-body">
                    <?php if ($aksesaddbtn->num_rows()>0): ?>
                     <h6 class="m-0 font-weight-bold text-primary"> <a class="text-info" style="text-decoration: none" class="collapse-item" href="<?php echo base_url()?>tambahdatamatauang"> <i class="fas fa-fw fa-plus text-info"></i> <?php echo $this->lang->line('add'); ?> Data <?php echo $this->lang->line('currency'); ?></h6></a>
                    <?php endif ?><br>
                                ...
                                <table style="border-collapse: 1;color: #858796;border-bottom: 2px solid #e3e6f0;"  id="dataTable" width="100%" height="1px" cellspacing="0">
                                    <thead>
                                        <tr height="20px">
                                            ...
                                            <th style=" padding: 0.75rem;vertical-align: top;border-top: 1px solid #e3e6f0;"><?php echo $this->lang->line('symbol'); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="20%"><?php echo $data->symbol?></td>
                                          <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="20%">
                                             <?php if ($aksesupdatebtn->num_rows()>0): ?>
                                              <a href="<?= base_url('editdatamatauang/' . $data->id_matauang); ?>" class="btn btn-sm btn-success" role="button" title="Ubah"><i class="fas fa-fw fa-pencil-alt"></i> <?php echo $this->lang->line('change'); ?> </a>
                                            <?php endif ?>
                                            <?php if ($aksesdeletebtn->num_rows()>0): ?>
                                             <a href="#" data-toggle="modal" data-target="#deleteModal" data-id="<?= $data->id_matauang; ?>" class="btn btn-sm btnOpenDeleteModal btn-danger mr-1" title="Hapus" onclick="openDeleteModal(this, 'matauang/deletematauang')" class="btn btn-sm btn-danger" role="button" title="Hapus">  <i class="fas fa-fw fa-trash"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                            <?php endif ?>
