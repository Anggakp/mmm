<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
            <h4  class="card-category"><?php echo $this->lang->line('add'); ?> Data <?php echo $this->lang->line('employee'); ?></h4>
        <div class="shadow card"> 
          <div class="card-body"> 
            <form action="<?php echo base_url() . 'tambahdatakaryawan'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              
              <div class="row">
                <div class="col-md-4">
                  <label class="bmd-label-floating">NIP<small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="text" name="nip" class="form-control" value="<?= set_value('nip') ?>">
                    <?= form_error('nip', '<small class="text-danger">', '</small>'); ?>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label class="bmd-label-floating">NIK<small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="text" name="nik" class="form-control" value="<?= set_value('nik') ?>">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="date" name="tanggalmasuk" class="form-control" value="<?= set_value('tanggalmasuk') ?>">
                  ...
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('part'); ?><small class="text-danger">*</small></label>
                     <select  name="bagian" class="form-control" required >
                        <option value="">======= <?php echo $this->lang->line('pleasechoice'); ?> <?php echo $this->lang->line('part'); ?> =======</option>
                        <?php
