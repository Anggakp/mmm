<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
            <h4 style="margin-bottom: 5px;padding-bottom: 5px" class="card-category">Edit Data <?php echo $this->lang->line('framefee'); ?></h4>
        <div class="shadow card"> 
          <div class="card-body">
             <?php
             foreach($ongkosrangka as $data){
             
            ?>
            <form action="<?php echo base_url() . 'ongkosrangka/updateongkosrangka'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                 <div class="col-md-6">
                    <label><?php echo $this->lang->line('typedesign'); ?><small class="text-danger">*</small></label>
                    <div class="input-group">
                                      
                      <input style="padding-bottom: 10px;width: 160px;" id="tipedesign"   type="text" name="tipedesign" class="tipedesign form-control" required value="<?= $data->tipedesign?>">
                                      
                      <input style="padding-bottom: 10px;width: 160px;" id="idtipedesign"   type="hidden" name="idtipedesign" class="idtipedesign form-control"  value="<?= $data->idtipedesign?>" readonly>
                  ...
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('difficulty'); ?><small class="text-danger">*</small></label>
                     <select name="kesulitan" required class="form-control">
                       <option value="<?=$data->kesulitan?>">Data Asal : <?=$data->kesulitan?></option>
                  ...
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('size'); ?><small class="text-danger">*</small></label>
                     <select name="ukuran" required class="form-control">
                       <option value="<?=$data->ukuran?>">Data Asal :  <?=$data->ukuran?></option>
              ...
              <div class="row">
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="noro" required class="form-control">
                       <option value="<?=$data->noro?>">Data Asal : <?=$data->noro?></option>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="hidden" name="idongkosrangka" class="form-control" value="<?= $data->id_ongkosrangka ?>" required>
                    <input style="padding-bottom: 10px;text-align: right;" type="text" name="ongkosrangka" class="js-nilai form-control" value="<?= $data->ongkosrangka ?>" required>
