<div class="content">
  <div class="container-fluid">
    <h6 class="m-0 font-weight-bold text-primary" align="right"> <a style="text-decoration: none" class="collapse-item text-info" href="<?php echo base_url() ?>listtipedesign"> <?php echo $this->lang->line('back'); ?></h6></a><br>
    
      <?= $this->session->flashdata('message');?>
    <div class="row">
      <div class="col-md-12">
        <h4 style="margin-bottom: 5px;padding-bottom: 5px" class="card-category">Edit Data <?php echo $this->lang->line('typedesign'); ?></h4>
        <div class="shadow card"> 
          <div class="card-body"> 
            ...
            ?>
            <form action="<?php echo base_url() . 'tipedesign/updatetipedesign'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('typedesign'); ?><small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="hidden" name="idtipe" class="form-control" value="<?= $data->id_tipe ?>" required>
                    <input style="padding-bottom: 10px;" type="text" name="tipedesign" class="form-control" value="<?= $data->tipedesign ?>" required>
