<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
            <h4 style="margin-bottom: 5px;padding-bottom: 5px" class="card-category">Edit Data <?php echo $this->lang->line('productcolor'); ?></h4>
        <div class="shadow card"> 
          <div class="card-body"> 
            ...
            ?>
            <form action="<?php echo base_url() . 'warnaproduk/updatewarnaproduk'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('productcolor'); ?><small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="hidden" name="idwarnaproduk" class="form-control" value="<?= $data->id_warnaproduk ?>" required>
                    <input style="padding-bottom: 10px;" type="text" name="namawarnaproduk" class="form-control" value="<?= $data->warnaproduk ?>" required>
