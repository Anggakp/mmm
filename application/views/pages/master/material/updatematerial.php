<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <h4 style="margin-bottom: 5px;padding-bottom: 5px;" class="card-category">Edit Data <?php echo $this->lang->line('material'); ?></h4>
        <div class="shadow card"> 
          <div class="card-body">
             <?php
             foreach($material as $data){ 
            ?>
            <form action="<?php echo base_url() . 'material/updatematerial'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('material'); ?><small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="hidden" name="idmaterial" class="form-control" value="<?= $data->id_material ?>" required>
                    <input style="padding-bottom: 10px;" type="text" name="namamaterial" class="form-control" value="<?= $data->material ?>" required>
