      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category"><?php echo $this->lang->line('entry'); ?> Data <?php echo $this->lang->line('productmaster'); ?></p>
          </div>
          <div class="card-body">
            <h4>Data <?php echo $this->lang->line('productmaster'); ?></h4>
            <hr>
            <form action="<?php echo base_url() . 'tambahdatabahanbaku'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('productmaster'); ?><small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="text" name="namabahanbaku" class="form-control" value="<?= set_value('namabahanbaku') ?>">
                    <?= form_error('namabahanbaku', '<small class="text-danger">', '</small>'); ?>
                  </div>
                </div>
                 <div class="col-md-6">
                  <div class="form-group">
