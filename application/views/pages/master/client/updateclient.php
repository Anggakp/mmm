<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
            <h4 style="margin-bottom: 5px;padding-bottom: 5px" class="card-category"><?php echo $this->lang->line('change'); ?> Data <?php echo $this->lang->line('client'); ?></h4>
        <div class="shadow card"> 
          <div class="card-body"> 
            <?php 
             ...
             ?>
            <form action="<?php echo base_url() . 'client/updateclient'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="subaccount" class="form-control" value="<?= $data->subaccount ?>">
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="kota" class="form-control" value="<?= $data->kota ?>">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="provinsi" class="form-control" value="<?= $data->provinsi ?>">
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="kodepos" class="form-control" value="<?= $data->kodepos ?>">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="phone" class="form-control" value="<?= $data->phone ?>">
                  </div>
                </div>
                 <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('contact'); ?><small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="text" name="kontak" class="form-control" value="<?= $data->kontak ?>">
                  </div>
                </div>
              </div>
              <div class="row">
