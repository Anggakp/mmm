<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
         <h4 style="margin-bottom: 5px;padding-bottom: 5px" class="card-category"><?php echo $this->lang->line('add'); ?> Data Parcel</h4>
            ...
            <form action="<?php echo base_url() . 'tambahdataparcel'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;text-align: right;" type="text" name="hargabeli" class="form-control js-nilai" value="<?= set_value('hargabeli') ?>">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;text-align: right"  type="text" name="hargajual" class="form-control js-nilai" value="<?= set_value('hargajual') ?>">
