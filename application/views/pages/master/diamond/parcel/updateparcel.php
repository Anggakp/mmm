<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <h4 class="card-category"><?php echo $this->lang->line('change'); ?> Data Parcel</h4>
        <div class="shadow card"> 
          <div class="card-body"> 
             <?php
             foreach($parcel as $data) 
             ?>
            <form action="<?php echo base_url() . 'parcel/updateparcel'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                  <div class="col-md-6">
              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;text-align: right" type="text" name="hargajual" class="js-nilai form-control" value="<?= $data->hargajual?>">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;text-align: right"  type="text" name="hargabeli" class="js-nilai form-control" value="<?= $data->hargabeli?>">
