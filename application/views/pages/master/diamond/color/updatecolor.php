<div class="content">
  <div class="container-fluid">
    <h6 class="m-0 font-weight-bold text-primary" align="right"> <a style="text-decoration: none" class="collapse-item text-info" href="<?php echo base_url() ?>listcolor"> <?php echo $this->lang->line('back'); ?></h6></a><br>
    
      <?= $this->session->flashdata('message');?>
    <div class="row">
      <div class="col-md-12">
        <h4 class="card-category" style="margin-bottom: 5px;padding-bottom: 5px"><?php echo $this->lang->line('change'); ?> Data <?php echo $this->lang->line('color'); ?></h4>
        <div class="shadow card">
          <div class="card-body"> 
             <?php
             foreach($color as $data){ 
            ?>
            <form action="<?php echo base_url() . 'color/updatecolor'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('color'); ?><small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="hidden" name="idcolor" class="form-control" value="<?= $data->id_color ?>" required>
                    <input style="padding-bottom: 10px;" type="text" name="namacolor" class="form-control" value="<?= $data->color ?>" required>
