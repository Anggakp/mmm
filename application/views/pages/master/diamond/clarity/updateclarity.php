<div class="content">
  <div class="container-fluid">
    <h6 class="m-0 font-weight-bold text-primary" align="right"> <a style="text-decoration: none" class="collapse-item text-info" href="<?php echo base_url() ?>listclarity"> <?php echo $this->lang->line('back'); ?></h6></a><br>
    
      <?= $this->session->flashdata('message');?>
    <div class="row">
      <div class="col-md-12">
            <h4 style="padding-bottom: 5px;margin-bottom: 5px;" class="card-category"><?php echo $this->lang->line('change'); ?> Data <?php echo $this->lang->line('clarity'); ?></h4>
        <div class="shadow card">
          <div class="card-body">
            <h4>Data <?php echo $this->lang->line('clarity'); ?></h4>
            <hr>
             <?php
             foreach($clarity as $data){
             
            ?>
            <form action="<?php echo base_url() . 'clarity/updateclarity'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating"><?php echo $this->lang->line('clarity'); ?><small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="hidden" name="idclarity" class="form-control" value="<?= $data->id_clarity ?>" required>
                    <input style="padding-bottom: 10px;" type="text" name="namaclarity" class="form-control" value="<?= $data->clarity ?>" required>
