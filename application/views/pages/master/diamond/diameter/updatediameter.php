<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <h4 style="margin-bottom: 5px;padding-bottom: 5px" class="card-category"><?php echo $this->lang->line('change'); ?> Data Diameter</h4>
        <div class="shadow card"> 
          <div class="card-body">
            ...
            ?>
            <form action="<?php echo base_url() . 'diameter/updatediameter'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
