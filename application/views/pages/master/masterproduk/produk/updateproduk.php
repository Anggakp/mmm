<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <h4 style="margin-bottom: 5px;padding-bottom: 5px;"class="card-category"><?php echo $this->lang->line('change'); ?> Data <?php echo $this->lang->line('productmaster'); ?></h4>
              ...
              <div class="row" style="margin-bottom: 20px;">
               ...
               <div class="row" style="margin-bottom: 20px;">
                   <div class="col-md-12">
                      ...
                      <div class="input-group">
                      <textarea id="summernote"  style="padding-bottom: 10px;max-width: 680px; margin-left: 38px;" name="deskripsiproduk" class="form-control"><?= $data->deskripsiproduk ?> </textarea>
                     </div>
              ...
              <div class="row" style="margin-bottom: 20px;">
                 <div class="col-md-6">          
                      <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 220px; margin-left: 80px;text-align: right;"  type="text"   value="<?php echo number_format($data->hargajual,0,',','.') ?>" name="hargajual" class="form-control js-nilai" required ><br>
                ...
                <div class="col-md-6">
                  <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 220px; margin-left: 53px;text-align: right;"  type="text"   value="<?php echo number_format($data->hargabeli,0,',','.') ?>" name="hargabeli" class="form-control js-nilai" required><br>
              ...
              <div class="row" style="margin-bottom: 20px;">
                 <div class="col-md-6">          
                      <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 150px; margin-left: 118px;"  type="number" step="any" value="<?= $data->berat ?>" required name="berat" class="form-control"><br>
                ...
                <div class="col-md-6">
                   <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 150px; margin-left: 70px;"  type="number" step="any" value="<?= $data->panjang ?>" required name="panjang" class="form-control"><br>
               ...
               <div class="row" style="margin-bottom: 20px;">
                 <div class="col-md-6">          
                      <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 150px; margin-left: 118px;"  type="number" step="any" value="<?= $data->lebar ?>" required name="lebar" class="form-control"><br>
                          <input style="padding-bottom: 10px;max-width: 70px;" readonly type="text" value="Cm" name="satuan" class="form-control">
                ...
                <div class="col-md-6">
                  <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 150px; margin-left: 80px;"  type="number" step="any" value="<?= $data->tinggi ?>" required name="tinggi" class="form-control"><br>
                          <input style="padding-bottom: 10px;max-width: 70px;" readonly type="text" value="Cm" name="satuan" class="form-control">
                          <?= form_error('panjang', '<small class="text-danger" style="margin-left:162px;">', '</small>'); ?>
                     </div>
                </div>
                                          ...
                                          <div class="drop-zone">
                                           <?php if ($data->gambar1 == "Tidak Ada File"): ?>
                                                <div class="drop-zone__thumb" data-label="<?=$data->gambar1?>">
                                                   <img src="" alt="" class="iimg-preview">
                                            </div>
                                              <?php endif ?>
                                               <?php if ($data->gambar1 != "Tidak Ada File"): ?>
                                                <div class="drop-zone__thumb" data-label="<?=$data->gambar1?>">

                                               <img src="<?= base_url('assets/file/masterproduk/'). $data->gambar1?>" alt="" id="img" class="iimg-preview  img-preview">
                                                </div>
                                              <?php endif ?>
                                      ...
                                      <div class="col-md-2" style="margin-right: 56px;">
                                          ...
                                          <?php if ($data->gambar2 == "Tidak Ada File"): ?>
                                              ...
                                              <?php endif ?>
                                               ...
                                               <img src="<?= base_url('assets/file/masterproduk/'). $data->gambar2?>" alt="" class="img-preview">
                                                </div>
                                              <?php endif ?>
                                          ...
                                          <div class="drop-zone">
                                           <?php if ($data->gambar3 == "Tidak Ada File"): ?>
                                              ...
                                              <?php endif ?>
                                               ...
                                               <img src="<?= base_url('assets/file/masterproduk/'). $data->gambar3?>" alt="" class="img-preview">
                                                </div>
                                              <?php endif ?>
                                          ...
                                          <div class="drop-zone">
                                           <?php if ($data->gambar4 == "Tidak Ada File"): ?>
                                              ...
                                              <?php endif ?>
                                               ...
                                               <img src="<?= base_url('assets/file/masterproduk/'). $data->gambar4?>" alt="" class="img-preview">
                                                </div>
                                              <?php endif ?>
                                          ...
                                          <div class="drop-zone">
                                            <?php if ($data->gambar5 == "Tidak Ada File"): ?>
                                              ...
                                              <?php endif ?>
                                               ...
                                               <img src="<?= base_url('assets/file/masterproduk/'). $data->gambar5?>" alt="" class="img-thumbnail  img-preview">
                                                </div>
                                              <?php endif ?>
