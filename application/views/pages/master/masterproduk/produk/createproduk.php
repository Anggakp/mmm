<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        <h4 style="margin-bottom: 5px;padding-bottom: 5px" class="card-category"><?php echo $this->lang->line('add'); ?> Data <?php echo $this->lang->line('productmaster'); ?></h4> 
              ...
              <div class="row" style="margin-bottom: 20px;">
               ...
               <div class="row" style="margin-bottom: 20px;">
                  <div class="col-md-12">
                      ...
                      <div class="input-group">
                      <textarea id="summernote"  style="padding-bottom: 10px;max-width: 680px; margin-left: 38px;" name="deskripsiproduk" class="form-control"><?= set_value('deskripsiproduk') ?> </textarea>
                     </div>
              ...
              <div class="row" style="margin-bottom: 20px;">
                 <div class="col-md-6">          
                      <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 220px; margin-left: 80px;text-align: right"  type="text"   value="<?= set_value('hargajual') ?>" name="hargajual" class="form-control js-nilai">
                     </div>
                ...
                <div class="col-md-6">
                  <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 220px; margin-left: 56px;text-align: right"  type="text" step="any" value="<?= set_value('hargabeli') ?>" name="hargabeli" class="form-control js-nilai"><br>
                     </div>
                </div>
              </div>
              <div class="row" style="margin-bottom: 20px;">
                 <div class="col-md-6">          
                      <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 150px; margin-left: 118px;"  type="number" step="any" value="<?= set_value('berat') ?>" name="berat" class="form-control"><br>
                ...
                <dvi class="col-md-6">
                   <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 150px; margin-left: 73px;"  type="number" step="any" value="<?= set_value('panjang') ?>" name="panjang" class="form-control"><br>
               ...
               <div class="row" style="margin-bottom: 20px;">
                 <div class="col-md-6">          
                      <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 150px; margin-left: 118px;"   type="number" step="any" value="<?= set_value('lebar') ?>" name="lebar" class="form-control"><br>
                          <input style="padding-bottom: 10px;max-width: 70px;" readonly type="text" value="Cm" name="satuan" class="form-control">
                     </div>
                ...
                <div class="col-md-6">
                    <div class="input-group">
                          ...
                          <input style="padding-bottom: 10px;max-width: 150px; margin-left: 85px;"   type="number" step="any" value="<?= set_value('tinggi') ?>" name="tinggi" class="form-control"><br>
                          <input style="padding-bottom: 10px;max-width: 70px;" readonly type="text" value="Cm" name="satuan" class="form-control">
                                      ...
                                      <div class="col-md-2" style="margin-right: 56px;">
                                       ...
                                       <div class="col-md-2" style="margin-right: 56px;">
                                          <div class="drop-zone">
                                            ...
                                            <input type="file" name="gambar5" class="drop-zone__input" value="<?= set_value('gambar5') ?>">
                                          </div>
                                      </div>
                                  </div><br>
