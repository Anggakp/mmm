  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
            ...
            <h4 style="margin-bottom: 5px;padding-bottom: 5px;" class="card-category"><?php echo $this->lang->line('add'); ?> Data MasterID</h4>
        <div class="shadow card">
           
          <div class="card-body"> 
             <?php
             foreach($masterid as $data){
             
            ?>
            <form action="<?php echo base_url() . 'masterid/updatemasterid'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="bmd-label-floating">MasterID<small class="text-danger">*</small></label>
                    <input style="padding-bottom: 10px;" type="hidden" name="idmasterid" class="form-control" value="<?= $data->id_masterid ?>" required>
                    <input style="padding-bottom: 10px;" type="text" name="masterid" class="form-control" value="<?= $data->masterid ?>" required>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="keterangan" class="form-control" value="<?= $data->keterangan ?>" required>
