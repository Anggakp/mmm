                   ...
                   <div class="row">
                                     <div class="col-md-4">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <input style="padding-bottom: 10px;" type="hidden" name="id_detail" id="id_detail" class="form-control" value="<?=$data->id_detail?>" readonly> 
                                        <input style="padding-bottom: 10px;max-width: 200px;" type="text" readonly name="model" class="form-control"   value="<?=$data->model?>">
                                       <!--  <input style="padding-bottom: 10px;max-width: 250px;margin-left: 5px;" placeholder="Kosongkan jika model sama" type="text" name="model_" class="form-control"> -->
                                        <input style="padding-bottom: 10px;max-width: 100px; margin-left: 5px;" readonly type="text" name="submodel" class="form-control" value="<?=$data->submodel?>" >
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                      <label><?php echo $this->lang->line('size'); ?><small class="text-danger">*</small></label>
                                        <input style="padding-bottom: 10px;width: 300px;text-align: right;"  type="number" step="any" value="<?=$data->size?>" name="ukuran" class="form-control">
                                          ...
                                          <div class="drop-zone">
                                           <?php if ($data->gambar1 == "Tidak Ada File"): ?>
                                              ...
                                              <?php endif ?>
                                               ...
                                               <img src="<?= base_url('assets/file/2ddesain/'). $data->gambar1?>" alt="" id="img" class="iimg-preview  img-preview">
                                                </div>
                                              <?php endif ?>
                                      ...
                                      <div class="col-md-2" style="margin-right: 56px;">
                                          ...
                                          <?php if ($data->gambar2 == "Tidak Ada File"): ?>
                                              ...
                                              <?php endif ?>
                                               ...
                                               <img src="<?= base_url('assets/file/2ddesain/'). $data->gambar2?>" alt="" class="img-preview">
                                                </div>
                                              <?php endif ?>
                                          ...
                                          <div class="drop-zone">
                                           <?php if ($data->gambar3 == "Tidak Ada File"): ?>
                                              ...
                                              <?php endif ?>
                                               ...
                                               <img src="<?= base_url('assets/file/2ddesain/'). $data->gambar3?>" alt="" class="img-preview">
                                                </div>
                                              <?php endif ?>
                                          ...
                                          <div class="drop-zone">
                                           <?php if ($data->gambar4 == "Tidak Ada File"): ?>
                                              ...
                                              <?php endif ?>
                                               ...
                                               <img src="<?= base_url('assets/file/2ddesain/'). $data->gambar4?>" alt="" class="img-preview">
                                                </div>
                                              <?php endif ?>
