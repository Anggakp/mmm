                   ...
                   <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                      <label><?php echo $this->lang->line('ongkoslainnya'); ?><small class="text-danger">*</small></label>
                                        <input style="padding-bottom: 10px;width: 300px;" readonly  type="text"   value="<?=$data->ongkoslainnya?>" name="size" class="form-control">
                                  </div>
                                </div><br>
                              ...
                              <table class="table table-hover" width="100%"  cellspacing="0">
                                ...
                                <br><br>
                                 ...
                                 <div class="row">
                                   ...
                                   <div class="col-md-3" > 
                                          <label>Video 1</label>
                                          <video controls width="400px" height="350px" >
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                      ...
                                      <a href="<?= base_url('tambahdata2ddesain'); ?>" class="btn btn-danger"><?php echo $this->lang->line('back'); ?></a>
                                     <?php endif ?>
                                       <?php if ($data->id_header != "0"): ?>
                                        <a href="<?= base_url("editdata2ddesain/$data->id_header"); ?>" class="btn btn-danger"><?php echo $this->lang->line('back'); ?></a>
                                     <?php endif ?>
                                </div>
