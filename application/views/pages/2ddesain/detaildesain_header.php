                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label><?php echo $this->lang->line('framefee'); ?><small class="text-danger">*</small></label>
                                         <input style="padding-bottom: 10px;width: 160px;" id="idongkosrangka" value="<?=$data->id_ongkosrangka?>"  type="hidden" name="idongkosrangka" class="form-control" readonly>
                                      <div class="input-group">
                                          
                                         <input style="padding-bottom: 10px;width: 160px;"   value="<?=$data->kesulitan?>"  type="text" name="kesulitan" class="form-control" readonly>
                                          <input style="padding-bottom: 10px;width: 160px;margin-left: 20px"   value="<?=$data->ukuran?>"  type="text" name="ukuran" class="form-control" readonly>
                                       </div>
                                    </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                      <label><?php echo $this->lang->line('size'); ?><small class="text-danger">*</small></label>
                                        <input style="padding-bottom: 10px;width: 300px;text-align: right;" readonly  type="number" step="any" value="<?=$data->size?>" name="size" class="form-control">
                                  </div>
                                   <div class="col-md-4">
                                      <label><?php echo $this->lang->line('ongkoslainnya'); ?><small class="text-danger">*</small></label>
                                        <input style="padding-bottom: 10px;width: 300px;" readonly  type="text" value="<?=$data->ongkoslainnya?>" name="ongkoslainnya" class="form-control">
                                  </div>
                                </div><br>
                                ...
                                <br>
                                 <div class="row">
                                  ...
                                  <div class="col-md-4">
                                        ...
                                        <input style="padding-bottom: 10px;max-width: 300px; margin-left:48px;text-align: right;"   type="text" name="hargaongkos_" value="<?php echo number_format($data->hargaongkos,0,',','.') ?>" readonly class="form-control">
                              ...
                              <table class="table table-hover" width="100%"  cellspacing="0">
                                ...
                                <br><br>
                                 ...
                                 ?>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-2">
                                      <label><?php echo $this->lang->line('picture'); ?> 1</label><br>
                                       
                                      <a href="<?= base_url('assets/file/2ddesain/'). $data->gambar1?>" data-toggle="lightbox" data-title="Gambar 1" data-gallery="gallery">
                                       
                                        <img src="<?= base_url('assets/file/2ddesain/'). $data->gambar1?>" class="img-fluid mb-2" alt="Tidak Ada File"/>
                                
                                      </a>
 
                                    </div>
                                    <div class="col-sm-2">
                                      <label><?php echo $this->lang->line('picture'); ?> 2</label><br>
                                      <a href="<?= base_url('assets/file/2ddesain/'). $data->gambar2?>" data-toggle="lightbox" data-title="<?php echo $this->lang->line('picture'); ?> 2" data-gallery="gallery">
                                       
                                        <img src="<?= base_url('assets/file/2ddesain/'). $data->gambar2?>" class="img-fluid mb-2" alt="Tidak Ada File"/>
                                      
                                      </a>
                                    </div>
                                    <div class="col-sm-2">
                                      <label><?php echo $this->lang->line('picture'); ?> 3</label><br>
                                      <a href="<?= base_url('assets/file/2ddesain/'). $data->gambar3?>" data-toggle="lightbox" data-title="<?php echo $this->lang->line('picture'); ?> 3" data-gallery="gallery">
                                        <img src="<?= base_url('assets/file/2ddesain/'). $data->gambar3?>" class="img-fluid mb-2" alt="Tidak Ada File"/>
                                      </a>
                                    </div>
                                    <div class="col-sm-2">
                                      <label><?php echo $this->lang->line('picture'); ?> 4</label><br>
                                      <a href="<?= base_url('assets/file/2ddesain/'). $data->gambar4?>" data-toggle="lightbox" data-title="<?php echo $this->lang->line('picture'); ?> 4" data-gallery="gallery">
                                        <img src="<?= base_url('assets/file/2ddesain/'). $data->gambar4?>" class="img-fluid mb-2" alt="Tidak Ada File"/>
                                      </a>
                                    </div>
                                    <div class="col-sm-2">
                                      <label><?php echo $this->lang->line('picture'); ?> 5</label><br>
                                      <a href="<?= base_url('assets/file/2ddesain/'). $data->gambar5?>" data-toggle="lightbox" data-title="<?php echo $this->lang->line('picture'); ?> 5" data-gallery="gallery">
                                        <img  src="<?= base_url('assets/file/2ddesain/'). $data->gambar5?>" class="img-fluid mb-2" alt="Tidak Ada File"/>
                                        <div id="zoom"></div>
                                      </a>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row">
                                   <div class="col-md-3" > 
                                          <label>Video 1</label>
                                          <video controls style="width: 400px;height: 350px">
