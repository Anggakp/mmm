                              ...
                              <div class="input-group">
                                        ...
                                        <input style="padding-bottom: 10px;max-width:300px; margin-left:55px;text-align:right"  value="<?php echo number_format($k->kepala,0,',','.') ?>" readonly  type="text" name="kepala_" class="form-control">
                                       </div>