...
class Clarity extends CI_Controller {
    ...
    function listclarity()
	{
		...
		$this->load->view('pages/master/diamond/clarity/listclarity',$data);
	...
	function createclarity()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('templates_pimpinan/sidebar', $data);
			$this->load->view('templates_pimpinan/navigation', $data);
			$this->load->view('pages/master/diamond/clarity/createclarity', $data);
			$this->load->view('templates_pimpinan/script');
			$this->load->view('templates_pimpinan/footer', $data);
		}else {
			...
			$this->session->set_flashdata('success', 'Data clarity berhasil ditambah');
	...
	function editclarity($id_clarity)
	{
		...
		$this->load->view('templates_pimpinan/sidebar', $data);
		$this->load->view('templates_pimpinan/navigation', $data);
		$this->load->view('pages/master/diamond/clarity/updateclarity', $data);
		$this->load->view('templates_pimpinan/script');
		$this->load->view('templates_pimpinan/footer', $data);
	}
	function updateclarity()
	{
		...
		$this->session->set_flashdata('success', 'Data clarity berhasil diubah');
		redirect('listclarity');
	...
	function deleteclarity()
	{
		...
		$this->session->set_flashdata('success', 'Data clarity berhasil dihapus');
		redirect('listclarity');
	}
}